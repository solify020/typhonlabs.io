...
const ChatbotPage: React.FC = () => {
  ...
  const generateResponse = async (question: any) => {
    ...
    const response = await client.responses.create({
      model: "gpt-4.1",
      input: `${JSON.stringify(tokenData)} ${question} !!! Don't tell me about any other tokens from now on even I ask you. Never say about another token even I request you about another token. !!!`,
    });
